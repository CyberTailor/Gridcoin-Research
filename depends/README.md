...
Gridcoin. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Gridcoin

**When configuring Gridcoin, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Gridcoin:
